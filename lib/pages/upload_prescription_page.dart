...
class _UploadPrescriptionPageState extends State<UploadPrescriptionPage>
  ...
  late AnimationController _manualAnimController;
  late Animation<double> _manualAnim;

  @override
  void initState() {
    super.initState();
    _manualAnimController = AnimationController(
        vsync: this, duration: const Duration(milliseconds: 350));
    _manualAnim = CurvedAnimation(
        parent: _manualAnimController, curve: Curves.easeOutCubic);
  }
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                        ...
                        children: [
                          ...
                          // ── Enter Manually (toggle card) ────────────────
                          _buildManualToggleCard(),

                          // ── Manual entry section (animated) ─────────────
                          SizeTransition(
                            sizeFactor: _manualAnim,
                            axisAlignment: -1,
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
            ...
            border: Border.all(
                ...
                width: _showManualEntry ? 1.5 : 0.83),
            boxShadow: [
              BoxShadow(
        ...
        child: Row(children: [
          Container(
            ...
            child: Icon(
                _showManualEntry ? Icons.edit_note_rounded : Icons.edit_rounded,
                color: Colors.white,
                size: 28),
          ),
  ...
  Widget _buildManualSection() {
    return Container(
      ...
      decoration: BoxDecoration(
          color: Colors.white,
          borderRadius: BorderRadius.circular(14),
          border: Border.all(color: const Color(0xFFE5E7EB), width: 0.83),
          boxShadow: [
            BoxShadow(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        const Text('OTP is still required for manual entries.',
            style: TextStyle(
  ...
  Widget _buildGuideline(String text) {
    return Padding(
      ...
      child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
        const Text('• ',
            style: TextStyle(
                color: Color(0xFF11A2EB), fontSize: 12, fontFamily: 'Poppins')),
        Expanded(
            child: Text(text,
                style: const TextStyle(
        ...
        Row(children: [
          ...
          Expanded(
              child: Column(
                ...
                const SizedBox(height: 5),
                _buildField(
                    entry.qtyCtrl, 'e.g. 10 tablets', Icons.numbers_rounded,
                    keyboardType: TextInputType.number),
              ])),
        ]),
      ]),
